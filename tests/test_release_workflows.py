...
UPLOAD_RELEASE_COMMAND = [
    ...
    "upload",
    "preview-pdf",
    "dist/ai-for-business-school.pdf",
    "dist/ai-for-business-school.html",
    "dist/SHA256SUMS",
    "--clobber",
]
...
upload_release = [
    "release", "upload", "preview-pdf", "dist/ai-for-business-school.pdf",
    "dist/ai-for-business-school.html", "dist/SHA256SUMS", "--clobber",
]
